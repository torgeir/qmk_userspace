...
[_FUN] = LAYOUT_ortho_4x12(
  ...
  KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, MO(_FUN_NUM), _______, /**/ KC_SPC,  _______,  KC_LEFT, KC_DOWN, KC_UP,   KC_DOWN
),
[_FUN_NUM] = LAYOUT_ortho_4x12(
...
[_LOWER] = LAYOUT_ortho_4x12(
  ...
  _______,     _______,      KC_NUBS/*<*/, S(KC_NUBS)/*>*/, _______,     _______,      /**/  _______,         KC_PLUS/*+*/, S(NO_LBRC)/*{*/, S(NO_RBRC)/*}*/, KC_PMNS/*-*/,    ALGR(KC_RBRC)/*~*/,
